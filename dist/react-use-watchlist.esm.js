...
var WatchlistContext = /*#__PURE__*/createContext(initialState);
...
var useWatchlist = function useWatchlist() {
  var context = useContext(WatchlistContext);
...
var WatchlistProvider = function WatchlistProvider(_ref) {
  ...
  var _React$useReducer = useReducer(reducer, JSON.parse(savedWatchlist)),
  ...
  return createElement(WatchlistContext.Provider, {
...
export { WatchlistProvider, createWatchlistIdentifier, initialState, useWatchlist };
//# sourceMappingURL=react-use-watchlist.esm.js.map
